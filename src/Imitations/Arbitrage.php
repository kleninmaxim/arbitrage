...
class Arbitrage
{
    ...
    {
        foreach ($memcached_orderbooks as $memcached_orderbook)
            $orderbooks[$memcached_orderbook['data']['orderbook']['exchange']][$memcached_orderbook['data']['orderbook']['symbol']] = $memcached_orderbook['data']['orderbook'];
