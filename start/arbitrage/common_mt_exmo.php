                 ...
                 if (isset($orderbooks[$market_discovery][$symbol])) {
                     if (
                         ...
                         if (isOrderInRange($limit_exchange_sell_order, $imitation_market_order)) {
                             if (createMirrorOrder($ccxt_exchange, $ccxt_market_discovery, $limit_exchange_sell_order, $symbol, $min_deal_amount, $amount_increment, false)) {
                                 unset($limit_exchange_sell_order);
                             }
                         } elseif (createMirrorOrder($ccxt_exchange, $ccxt_market_discovery, $limit_exchange_sell_order, $symbol, $min_deal_amount, $amount_increment, true)) {
                             unset($limit_exchange_sell_order);
                         }
                     } elseif (createMirrorOrder($ccxt_exchange, $ccxt_market_discovery, $limit_exchange_sell_order, $symbol, $min_deal_amount, $amount_increment, true)) {
                         unset($limit_exchange_sell_order);
                 ...
                 if (isset($orderbooks[$market_discovery][$symbol])) {
                     if (
                         ...
                         if (isOrderInRange($limit_exchange_buy_order, $imitation_market_order)) {
                             if (createMirrorOrder($ccxt_exchange, $ccxt_market_discovery, $limit_exchange_buy_order, $symbol, $min_deal_amount, $amount_increment, false)) {
                                 unset($limit_exchange_buy_order);
                             }
                         } elseif (createMirrorOrder($ccxt_exchange, $ccxt_market_discovery, $limit_exchange_buy_order, $symbol, $min_deal_amount, $amount_increment, true)) {
                             unset($limit_exchange_buy_order);
                         }
                     } elseif (createMirrorOrder($ccxt_exchange, $ccxt_market_discovery, $limit_exchange_buy_order, $symbol, $min_deal_amount, $amount_increment, true)) {
                         unset($limit_exchange_buy_order);
...
function createMirrorOrder(Ccxt $ccxt_exchange, Ccxt $ccxt_market_discovery, &$limit_exchange_order, $symbol, $min_deal_amount, $amount_increment, $is_cancel_order): bool
{
    if ($is_cancel_order) {
